...
import torch
import wandb
from transformers import BertTokenizerFast, HfArgumentParser, RobertaTokenizer, AutoTokenizer
...
if __name__ == '__main__':
    ...
    with open('./data/finetune.json', 'r', encoding='utf-8') as f:
        acm_program_dataset = json.load(f)
    custom_dataset = TrainingDataset(acm_program_dataset, tokenizer, max_length=512)
    ...
    config = DynamicDocumentEmbeddingConfig(model_name=pretrained_model_path)
